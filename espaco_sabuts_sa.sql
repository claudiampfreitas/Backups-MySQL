...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30/11/2025 às 17:29
...
--
-- Banco de dados: `espaco_sabuts_sa`
--
...
--
ALTER TABLE `item_pedido`
  MODIFY `id_item` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
...
--
ALTER TABLE `pessoa`
  MODIFY `id_pessoa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
